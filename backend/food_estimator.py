...
FOOD_RULES = [
    ...
    (["สปาเก็ต", "พาสต้า", "spaghetti", "pasta"], {"calories": 450, "protein": 14, "carbs": 68, "fat": 12}),
    (["เกาเหลา"], {"calories": 280, "protein": 24, "carbs": 10, "fat": 16}),
    (["เย็นตาโฟ"], {"calories": 420, "protein": 18, "carbs": 58, "fat": 14}),
    (["ก๋วยจั๊บ", "ก๋วยจ๊บ"], {"calories": 400, "protein": 18, "carbs": 55, "fat": 12}),
